...
class PlateTest < ActiveSupport::TestCase
  ...
  test "should prevent moving two plates to same location" do
    ...
    assert_raises(ActiveRecord::RecordInvalid) do
      @plate2.move_to_location!(@carousel_location, moved_by: "test")
    end
  ...
  test "should allow moving plate to different location" do
    ...
    @plate1.move_to_location!(@imager_location, moved_by: "test")
  ...
  test "should allow different plates in different locations" do
    ...
    @plate1.move_to_location!(@carousel_location, moved_by: "test")
    @plate2.move_to_location!(@imager_location, moved_by: "test")
